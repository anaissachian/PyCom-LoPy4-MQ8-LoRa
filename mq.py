...
class MQ():
    ...
    #MQ_PIN                       = 'P12'       # define which analog input channel you are going to use (MCP3008)
    RL_VALUE                     = 3.3       # define the load resistance on the board, in kilo ohms
    ...
    def __init__(self, analogPin, Ro=10):
        ...
        print("Calibrating MQ8...")
        self.Ro = self.MQCalibration(self.MQ_PIN)
        print("Calibration of MQ8 is done...\n")
    ...
    def MQRead(self):
        ...
        for i in range(self.READ_SAMPLE_TIMES):
            rs += self.MQResistanceCalculation(self.adc.read(self.MQ_PIN))
